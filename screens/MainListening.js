...
const FillBlanksTest = ({ route, navigation }) => {
  ...
  const question = rijec[questionIndex].word;
  
  const correctAnswer = rijec[questionIndex].explanation;
  ...
  const generateOptions = () => {
    ...
    while (tempOptions.length < 4) {
      ...
      if (
        ...
        const randomWord = rijec[randomIndex].explanation;
...
const speak = () => {
  ...
  return (
    ...
    <View style={styles.MainContent}>
        <TouchableOpacity style={styles.question} onPress={speak}><MaterialCommunityIcons name='account-voice' size={70} color="#333333"/><Text>*tap to hear*</Text></TouchableOpacity>
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <TouchableOpacity onPress={() => {
              setModalVisible(false);
              navigation.navigate('FillTheBlanks', { selectedLevel });
